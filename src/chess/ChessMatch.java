...
public class ChessMatch {
	...
	private ChessPiece king(Color color) {
		...
		throw new IllegalStateException("There is not " + color + "King ont the board");
	}
